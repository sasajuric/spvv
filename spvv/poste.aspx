<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeBehind="poste.aspx.cs" Inherits="spvv.wfPoste" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphGlavni" runat="server">
        ...
        <HeaderTemplate>
            <table style="border-collapse: collapse; width: 768px" class="grid">
                <tr class="header">
                    ...
                    <th style="width: 500px">Naziv</th>
                </tr>
        </HeaderTemplate>
        <ItemTemplate>
                <tr class="row" id="trMain<%# Eval("id") %>" onclick="grdMain_Click(<%# Eval("id") %>)">
                    <td style="width: 100px"><%# Eval("broj") %></td>
                    <td style="width: 500px"><%# Eval("naziv") %></td>
                </tr>
        </ItemTemplate>
    ...
    <table>
            <tr>
                <td>
                    <asp:Label Text="Broj:" AssociatedControlID="txtBroj" runat="server" />
                </td>
                <td>
                    <asp:TextBox ID="txtBroj" runat="server" onFocus="this.select()" />
                </td>
                <% if (action == "Traži" || action == "Filtriraj") { %>
                <td>
                    <asp:TextBox ID="txtBrojDo" runat="server" onFocus="this.select()" />
                </td>
                <% } %>
            </tr>
            <tr>
