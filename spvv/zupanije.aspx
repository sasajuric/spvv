<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeBehind="zupanije.aspx.cs" Inherits="spvv.wfZupanije" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphGlavni" runat="server">
    <div style="margin: auto; padding: 20px; border: 1px solid #A0A0A0; border-radius: 10px; background: white; width: 100%; height: 100%; box-sizing: border-box">
        <% if ((action == "") || (((action == "Izmijeni") || (action == "Obriši") || (action == "Kandidati") || (action == "Instruktori")) && (hdnID.Value == ""))) { %>
